  ...
  generateTicket() {
    if(this.generateForm.valid) {
      ...
      err => {
        ...
        this._notificationService.showError(`Your current active ticket number <mark>${err['data']['ticketNumber']}</mark> <a class="e-link" routerLink="/tickets">Check it out.</a>`);
      });
    }
  }
